...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, LT(2,KC_SPC),      KC_SPC, KC_RALT,                        KC_LEFT, KC_DOWN, KC_RIGHT // modifiers, 9 keys
  ),
  ...
  [1] = LAYOUT(
    ...
    KC_TRNS, KC_LGUI, KC_SPC, KC_LALT, KC_TRNS, MO(2), KC_TRNS, KC_TRNS, KC_TRNS // modifiers, 9 keys
  ),
