...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_NO, // zxcv, 13 keys
    KC_LCTL, KC_LALT, LGUI_T(KC_SPC), KC_NO, LT(2,KC_SPC), KC_RALT, KC_NO, KC_NO, KC_NO // modifiers, 9 keys
  ),
  ...
  // Function layout
  [2] = LAYOUT(
    DT_PRNT, DT_UP, DT_DOWN, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, // num row, 16 keys
